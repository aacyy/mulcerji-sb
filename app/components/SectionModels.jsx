	...
	const sbModels = [
		{
			...
			modelType: 'Goseničar',
			motor: 'Elektro motor - dve hitrosti',
			domet: 'Model 0 tekst',
						...
						<table>
							<tbody>
								...
								<tr className='tr-grey'>
									...
									<td>{filteredData.dimenzije} (V X G X Š )</td>
								</tr>
								<tr className='tr-white'>
				...
				<div className='sb-section-models-description-text'>
					...
					<div className='sb-section-models-description-content'>
						...
						>
							...
							<h3 className='sb-models-number'>+386 31 555 666</h3>
							<h4>ali nam pišite na:</h4>
							<div>
								<h3 className='sb-models-email'>info@kuser-mont.com</h3>
							</div>
						</div>
					</div>
				</div>
